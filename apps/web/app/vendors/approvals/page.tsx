      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400 mb-2">
            ...
            <span className="text-gray-900 dark:text-gray-100">Approvals</span>
          </div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Vendor Approvals</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">Review and approve new vendor registrations</p>
        </div>
        <button
        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-700">
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">No {activeTab} requests</h3>
            ...
            filteredRequests.map((request) => (
              <div key={request.id} className="p-6 hover:bg-gray-50 dark:hover:bg-gray-800">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{request.vendorName}</h3>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-900 dark:text-gray-100">{request.contactPerson}</p>
                        <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">{request.vendorEmail}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Category</p>
                        <p className="text-sm text-gray-900 dark:text-gray-100">{request.category}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-900 dark:text-gray-100">{request.documents?.length || 0} files</p>
                      </div>
                    </div>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="relative w-full max-w-md bg-white dark:bg-gray-900 rounded-xl shadow-2xl p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Reject Vendor</h3>
