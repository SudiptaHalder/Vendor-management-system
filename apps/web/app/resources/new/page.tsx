    ...
    <MainLayout>
      ...
      <div className="mb-6">
        <div className="flex items-center space-x-3 text-sm text-gray-500 dark:text-gray-400 mb-4">
          ...
          <span>/</span>
          <span className="text-gray-900 dark:text-gray-100 font-medium">New Resource</span>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Add New Resource</h1>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Add equipment, tools, vehicles or personnel</p>
            </div>
          </div>
          <Link
            href="/resources"
