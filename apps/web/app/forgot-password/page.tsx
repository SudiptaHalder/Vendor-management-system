    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Password Reset Unavailable</h2>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Self-service password reset isn&apos;t set up yet. Please contact your administrator to reset your password.
          </p>
          <Link
            href="/vendor-login"
            className="mt-6 inline-flex items-center text-sm font-medium text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300"
          >
