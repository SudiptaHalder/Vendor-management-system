    ...
    <MainLayout>
      ...
      <div className="mb-6">
        <div className="flex items-center space-x-3 text-sm text-gray-500 dark:text-gray-400 mb-4">
          ...
          <span>/</span>
          <Link href={`/procurement/bids/${params.id}`} className="hover:text-purple-600 dark:hover:text-purple-400">
            {params.id}
          </Link>
          <span>/</span>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Edit Bid</h1>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Update bid information</p>
            </div>
          </div>
          <Link
