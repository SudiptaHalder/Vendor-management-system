...
export default function QuotesPage() {
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig: Record<string, { color: string, icon: any, label: string }> = {
      ...
      under_review: { color: 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300', icon: Clock, label: 'Under Review' },
    ...
    <MainLayout>
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Review and manage vendor quotes</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-800">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">{stats.accepted}</p>
            </div>
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-12 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">No quotes yet</h3>
          <p className="text-gray-500 dark:text-gray-400 mb-6">Quotes will appear here once vendors respond to your RFQs.</p>
          <Link
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50 dark:bg-gray-800">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Quote #</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">RFQ</th>
