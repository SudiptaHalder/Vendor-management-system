...
export default function ContractsPage() {
  ...
  const getSignatureStatus = (contract: Contract) => {
    if (contract.signedByCompany && contract.signedByVendor) {
      return <span className="text-xs text-green-600 dark:text-green-400 flex items-center"><CheckCircle size={12} className="mr-1" />Fully Signed</span>
    } else if (contract.signedByCompany) {
      return <span className="text-xs text-blue-600 dark:text-blue-400 flex items-center"><Clock size={12} className="mr-1" />Awaiting Vendor</span>
    } else if (contract.signedByVendor) {
      return <span className="text-xs text-blue-600 dark:text-blue-400 flex items-center"><Clock size={12} className="mr-1" />Awaiting Company</span>
    } else {
      return <span className="text-xs text-gray-500 dark:text-gray-400 flex items-center"><FileCheck size={12} className="mr-1" />Not Signed</span>
    }
  }
    ...
    <MainLayout>
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Manage vendor contracts and agreements</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-800">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">{stats.pending_approval + stats.pending_signature}</p>
            </div>
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-12 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">No contracts yet</h3>
          <p className="text-gray-500 dark:text-gray-400 mb-6">Create your first contract to formalize agreements with vendors.</p>
          <Link
            href="/procurement/contracts/new"
            ...
            <table className="w-full">
              <thead className="bg-gray-50 dark:bg-gray-800">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Signature</th>
