...
export default function EditInvoicePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await api.updateInvoice(params.id as string, invoiceData)
    ...
    return (
      <MainLayout>
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-12 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Invoice not found</h3>
          <Link
            href="/invoices"
    ...
    <MainLayout>
      ...
      <div className="mb-6">
        <div className="flex items-center space-x-3 text-sm text-gray-500 dark:text-gray-400 mb-4">
          ...
          <span>/</span>
          <Link href={`/invoices/${params.id}`} className="hover:text-blue-600 dark:hover:text-blue-400">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Edit Invoice</h1>
