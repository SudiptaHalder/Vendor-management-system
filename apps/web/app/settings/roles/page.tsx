    ...
    <MainLayout>
      ...
      <div className="mb-6">
        <div className="flex items-center space-x-3 text-sm text-gray-500 dark:text-gray-400 mb-4">
          ...
          <span>/</span>
          <span className="text-gray-900 dark:text-gray-100 font-medium">Roles & Permissions</span>
        </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
            <div className="px-4 py-3 bg-gray-50 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-800">
              <h2 className="font-medium text-gray-700 dark:text-gray-300">All Roles</h2>
            </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2 ml-4">
                      <span className="text-xs text-gray-500 dark:text-gray-400">{role.userCount || 0} users</span>
                      {!role.isSystem && (
                        <button
              ...
              <div className="px-6 py-4 border-b bg-gray-50 dark:bg-gray-800">
                <div className="flex items-center justify-between">
                  ...
                  {!selectedRole.isSystem && (
                    <button className="px-3 py-1.5 text-sm text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20">
                      Edit Role
                    </button>
                  )}
                </div>
              ...
              <div className="p-6">
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr>
                        <th className="text-left text-sm font-medium text-gray-500 dark:text-gray-400 pb-4">Module</th>
                        {actions.map((action) => (
                          <th key={action} className="text-center text-sm font-medium text-gray-500 dark:text-gray-400 pb-4 px-2 capitalize">
                            {action}
                          </th>
                        ))}
                      </tr>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl max-w-md w-full p-6">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Create New Role</h2>
