    ...
    return (
      <MainLayout>
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-12 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Error Loading Document</h3>
          <p className="text-gray-500 dark:text-gray-400 mb-6">{error || 'Document not found'}</p>
          <Link
            href="/documents"
    ...
    <MainLayout>
      ...
      <div className="mb-6">
        <div className="flex items-center space-x-3 text-sm text-gray-500 dark:text-gray-400 mb-4">
          ...
          <span>/</span>
          <span className="text-gray-900 dark:text-gray-100 font-medium">{document.name}</span>
        </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <div className="flex items-center flex-wrap gap-3 mb-2">
                  <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{document.name}</h1>
                  {document.isConfidential && (
                    <span className="px-2 py-1 text-xs bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 rounded-full flex items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
            ...
            <div className="p-6">
              <dl className="grid grid-cols-2 gap-6">
                <div>
                  <dt className="text-xs text-gray-500 dark:text-gray-400 mb-1">File Name</dt>
                  <dd className="text-sm text-gray-900 dark:text-gray-100">{document.fileName}</dd>
                </div>
                <div>
                  <dt className="text-xs text-gray-500 dark:text-gray-400 mb-1">File Type</dt>
                  <dd className="text-sm text-gray-900 dark:text-gray-100">{document.fileType}</dd>
                </div>
                <div>
                  <dt className="text-xs text-gray-500 dark:text-gray-400 mb-1">File Size</dt>
                  <dd className="text-sm text-gray-900 dark:text-gray-100">{formatFileSize(document.fileSize)}</dd>
                </div>
                <div>
                  <dt className="text-xs text-gray-500 dark:text-gray-400 mb-1">Category</dt>
                  <dd className="text-sm text-gray-900 dark:text-gray-100">{document.category || '—'}</dd>
                </div>
                <div>
                  <dt className="text-xs text-gray-500 dark:text-gray-400 mb-1">Version</dt>
                  <dd className="text-sm text-gray-900 dark:text-gray-100">{document.version}</dd>
                </div>
                <div>
                  ...
                  <dd className="text-sm">
                    {document.isLatest ? (
                      ...
                      <span className="text-yellow-600 dark:text-yellow-400">Old Version</span>
                    )}
                  </dd>
                </div>
              </dl>
          ...
          {document.expiryDate && (
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
              <div className="px-6 py-4 border-b bg-gray-50 dark:bg-gray-800">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Expiry Information</h2>
              </div>
              <div className="p-6">
                <div className="flex items-center space-x-3">
        ...
        <div className="space-y-6">
          ...
          {entityLink && (
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
              <div className="px-6 py-4 border-b bg-gray-50 dark:bg-gray-800">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Linked Record</h2>
              </div>
              <div className="p-6">
                <Link
                  href={entityLink}
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">ID: {document.entityId}</p>
              </div>
            </div>
          )}
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
              ...
              <div className="p-6">
                ...
                {document.vendor.email && (
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">{document.vendor.email}</p>
                )}
              </div>
            </div>
          )}
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
            <div className="px-6 py-4 border-b bg-gray-50 dark:bg-gray-800">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Upload Information</h2>
            </div>
            <div className="p-6">
              <dl className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <dd className="text-sm text-gray-900 dark:text-gray-100 flex items-center">
                    <User size={14} className="mr-1 text-gray-400 dark:text-gray-500" />
                    {document.uploadedBy.name || document.uploadedBy.email}
                  </dd>
                </div>
                <div className="flex justify-between">
                  <dt className="text-xs text-gray-500 dark:text-gray-400">Uploaded On</dt>
              ...
              <div className="flex items-center space-x-2">
                {document.isConfidential ? (
                  <>
                    ...
                    <span className="text-sm font-medium text-gray-900 dark:text-gray-100">Confidential Document</span>
                  </>
                ) : (
                  <>
                    <Unlock className="w-5 h-5 text-gray-400 dark:text-gray-500" />
                    <span className="text-sm text-gray-500 dark:text-gray-400">Public Document</span>
                  </>
                )}
              </div>
            </div>
