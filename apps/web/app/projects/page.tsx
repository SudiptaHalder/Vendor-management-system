    ...
    <MainLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-800">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Planning</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">{stats.planning}</p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 border border-gray-100 dark:border-gray-800">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">{stats.onHold}</p>
            </div>
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-12 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-6">Create your first project to start tracking work.</p>
          <Link
            href="/projects/new"
                  ...
                  <tr key={project.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xs text-gray-600 dark:text-gray-400">{project.progressPercent || 0}%</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
