...
export default function NewProjectPage() {
  ...
  const fetchManagers = async () => {
    ...
    try {
      // You need to implement this API method to get users who can be project managers
      const response = await api.getUsers({ role: 'project_manager' })
      if (response.success) {
  ...
  return (
    <MainLayout>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Start a new project and set up initial details</p>
            </div>
          </div>
          <Link
            href="/projects"
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Project Manager */}
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-6">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Project Manager</h2>
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              Assign Manager
            </label>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              You can assign a manager later if not decided yet
            </p>
          </div>
        </div>
