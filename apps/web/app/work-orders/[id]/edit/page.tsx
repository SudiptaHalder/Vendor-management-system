    ...
    <MainLayout>
      ...
      <div className="mb-6">
        <div className="flex items-center space-x-3 text-sm text-gray-500 dark:text-gray-400 mb-4">
          ...
          <span>/</span>
          <Link href={`/work-orders/${params.id}`} className="hover:text-blue-600 dark:hover:text-blue-400">
            {params.id}
          </Link>
          <span>/</span>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Update work order details</p>
            </div>
          </div>
          <Link
            href={`/work-orders/${params.id}`}
