    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-800 py-12 px-4">
        <div className="max-w-md w-full bg-white dark:bg-gray-900 rounded-xl shadow-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Account Created Successfully!</h2>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h2 className="mt-4 text-3xl font-bold text-gray-900 dark:text-gray-100">Set Up Your Account</h2>
          <p className="text-gray-600 dark:text-gray-400 mt-2">Welcome to the Vendor Portal! Please set your password.</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6 sm:p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled
                  className="w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-400 rounded-lg cursor-not-allowed"
                />
              </div>
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Your vendor code is provided by the system</p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">This email is associated with your vendor account</p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  disabled={submitting}
                  className="w-full pl-10 pr-10 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
            ...
            {error && (
              <div className="p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg flex items-center space-x-2 text-red-700 dark:text-red-300">
          ...
          <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link href="/vendor-login" className="font-medium text-green-600 dark:text-green-400 hover:text-green-500">
              Sign in
            </Link>
          </p>
        </div>
